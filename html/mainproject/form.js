        ...
        function validation(){
            ...
            var dateofbirth = document.login.dateofbirth.value;
            var phone = document.login.phone.value;
            var gender = document.login.gender.value;
            var reg = document.login.reg.value;
            var country = document.login.country.value;
            var state = document.login.state.value;
            var address = document.login.address.value;
            var pcountry = document.login.pcountry.value;
            var pstate = document.login.pstate.value;
            var paddress = document.login.paddress.value;
            var occupation = document.login.occupation.value;
            var email = document.login.email.value;
            var filename = document.login.filename.value;
